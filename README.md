...
For square corners in other windows elements (Action Center, Flyouts), copy the respective file content from `Windhawk` directory and paste it in Advanced Settings --> Mod Settings in the following mods
